 ...
 * @version 1.0
 */
public class IsNotNullExpression extends PropertyBasedExpression {

	private static final long serialVersionUID = 2649854125072367915L;

	public IsNotNullExpression(final String prop) {
		super(prop);
	}
