 ...
 * (i.e. a "field") is less than to the value of the <code>otherProperty</code>
 * (i.e., another field).
 * 
 * @author ocherednichenko
 * @version 1.0
 */
public class LessThanPropertyExpression extends PropertyOtherPropertyExpression {

	private static final long serialVersionUID = -3954995473745097171L;

	public LessThanPropertyExpression(final String property,
