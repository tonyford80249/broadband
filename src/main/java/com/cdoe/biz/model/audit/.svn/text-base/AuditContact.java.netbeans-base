...
@XmlRootElement
@Entity
@Table(name = "`AUDIT_CONTACT`")
public class AuditContact implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name="AUDIT_CONTACT_SEQ", sequenceName="AUDIT_CONTACT_SEQ")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="AUDIT_CONTACT_SEQ")
	@Column
	private Long id;
