...
@XmlRootElement
@Entity
@Table(name = "`AUDIT_DUPLICATE_COUNT`")
public class AuditDuplicateCount implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name="AUDIT_DUPLICATE_COUNT_SEQ", sequenceName="AUDIT_DUPLICATE_COUNT_SEQ")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="AUDIT_DUPLICATE_COUNT_SEQ")
	@Column
	private Long id;
