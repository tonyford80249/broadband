...
@XmlRootElement
@Entity
@Table(name = "CROSSWALK_ESL")
public class CrosswalkESL implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name="CROSSWALK_ESL_SEQ", sequenceName="CROSSWALK_ESL_SEQ")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="CROSSWALK_ESL_SEQ")
	@Column
	private Long id;
	...
	public Integer getEslCsap() {
		return eslCsap;
	}
	public void setEslCsap(Integer eslCsap) {
