...
@XmlRootElement
@Entity
@Table(name = "CROSSWALK_ASCENT")
public class CrosswalkAscent implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name="CROSSWALK_ASCENT_SEQ", sequenceName="CROSSWALK_ASCENT_SEQ")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="CROSSWALK_ASCENT_SEQ")
	@Column
	private Long id;
	...
	public void setAscentTotal(Double ascentTotal) {
		this.ascentTotal = ascentTotal;
	}
