 ...
 */
@Entity
@Table(name = "CROSSWALK_FTE_BY_GRADE")
public class CrosswalkFteByGrade implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name="CROSSWALK_FTE_BY_GRADE_SEQ", sequenceName="CROSSWALK_FTE_BY_GRADE_SEQ")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="CROSSWALK_FTE_BY_GRADE_SEQ")
	@Column
	private Long id;
