...
public class Csi implements Serializable {
    ...
    @Column(name="`IP_WITHHOLDING`")
    private Double interceptProgramWithholding;

    public Double getInterceptProgramWithholding() {
        return interceptProgramWithholding;
    }

    public void setInterceptProgramWithholding(Double interceptProgramWithholding) {
        this.interceptProgramWithholding = interceptProgramWithholding;
    }
    
    @Column(name="`AT_RISK_ADJUSTMENT`")
    ...
    @Column(name="`CSI_PPR_FDK_FACTOR`")
    private Double pprFdkFactor;

    public Double getPprFdkFactor() {
        return pprFdkFactor;
    }

    public void setPprFdkFactor(Double pprFdkFactor) {
        this.pprFdkFactor = pprFdkFactor;
    }
