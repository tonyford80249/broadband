...
public class DateUtil {
	...
	public static String getFormattedDateNextMonth(String formatString) {
		Date date = new Date();
	...
	public static String getFormattedDate() {
     ...
     static String[][] months =  { {"January", "01"},
		 {"February", "02"},
		 {"March", "03"},
		 {"April", "04"},
		 {"May", "05"},
     ...
     public static String getMonthNos(String monthName) {
	 String monthNos = "";
	 for(String[]  month : months) {
		 if (monthName.equalsIgnoreCase(month[0])) {
     ...
     public static String getMonthName(String monthNumber) {
    	 String monthNos = (monthNumber.length() == 1) ? "0" + monthNumber : monthNumber;
    	 String monthName = "";
    	 for(String[]  month : months) {
    		 if (monthNos.equalsIgnoreCase(month[1])) {
	...
	public static void main(String[] args) {
		System.out.println("The month nos is " + getMonthNos("June"));
	}
