...
public class ReportGenerationValidator implements Validator {
	...
	private static final Logger logger = Logger.getLogger(ReportGenerationValidator.class);
	...
	public void validate(Object target, Errors errors) {
		...
		if (form.getReports() == null || form.getReports().isEmpty()) {                       
	          errors.rejectValue("reports", "integer", "You must select at least one report to be generated.");
                ...
                if (form.getMonth() == null || CalendarMonth.getInstance(form.getMonth().trim()) == null) {
