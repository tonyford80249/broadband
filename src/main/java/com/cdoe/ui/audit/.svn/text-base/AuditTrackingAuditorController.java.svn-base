...
@Controller
@RequestMapping("/secure/AuditTrackingAuditor")
public class AuditTrackingAuditorController {

	private static final Logger logger = Logger.getLogger(AuditTrackingAuditorController.class);
    ...
    public String index(Model model) {
		...
		return ".AuditTrackingAuditor-index";
    }
