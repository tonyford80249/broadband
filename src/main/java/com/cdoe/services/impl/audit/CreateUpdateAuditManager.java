...
public class CreateUpdateAuditManager extends BaseManager implements ICreateUpdateAuditManager {

	private static final Logger logger = Logger.getLogger(CreateUpdateAuditManager.class);
