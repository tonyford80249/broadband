...
public class BillingUpdateManager extends BaseManager implements IBillingUpdateManager {

	private static final Logger logger = Logger.getLogger(BillingUpdateManager.class);
	
	private IAuditBillingDAO changeBillingDAO;
	...
	public void setChangeBillingDAO(IAuditBillingDAO changeBillingDAO) {
