			...
			<TR>
				<TD>
					<div class="formBlock boxShadow3 radius10">
						<h3>
							Contact information of the person preparing the report
						</h3>
					...
					<TABLE>
						...
						<TR>
							...
							<TD width="22%"><form:input id="DaysSchoolWasInSession"
												path="schoolDays" onBlur="formatIntegerField('DaysSchoolWasInSession')"/>
											<font color="red"><b>*</b> <form:errors path="schoolDays" cssClass="validationError" />
											</font>
						    </td>
						</TR>
						...
						<TR>
							...
							<TD><form:input id="BoardTran" path="boardTran" onBlur="formatIntegerField('BoardTran')"/>
						...
						<TR>
							...
							<TD><form:input id="NosOfPupilSchedules" path="pupilTran" onBlur="formatIntegerField('NosOfPupilSchedules')"/><font
